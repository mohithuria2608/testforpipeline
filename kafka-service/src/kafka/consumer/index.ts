...
import { retry1ConsumerE } from './retry1.consumer';
import { retry2ConsumerE } from './retry2.consumer';
import { retry3ConsumerE } from './retry3.consumer';
...
export function initConsumers() {
    ...
    retry1ConsumerE.handleMessage();
    retry2ConsumerE.handleMessage();
    retry3ConsumerE.handleMessage()
}