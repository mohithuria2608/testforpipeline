        ...
        try {
            let data = {
                ...
                req: {
                    ...
                    language: payload.language.toLowerCase().trim(),
                    orderID: payload.sdmOrderRef,
                    paymentType: config.get("sdm.payment.card.payType"),// Constant.CONF.PAYMENT[Constant.DATABASE.STORE_CODE.MAIN_WEB_STORE].codInfo.SDM.PAY_TYPE,
                    paymentSubType: config.get("sdm.payment.card.paySubType"),// Constant.CONF.PAYMENT[Constant.DATABASE.STORE_CODE.MAIN_WEB_STORE].codInfo.SDM.PAY_SUB_TYPE,
                    paymentStatus: config.get("sdm.payment.card.payStatus"),// Constant.CONF.PAYMENT[Constant.DATABASE.STORE_CODE.MAIN_WEB_STORE].codInfo.SDM.PAY_STATUS,
                    paymentTenderID: config.get("sdm.payment.card.payStoreTenderId"),// Constant.CONF.PAYMENT[Constant.DATABASE.STORE_CODE.MAIN_WEB_STORE].codInfo.SDM.PAY_STORE_TENDERID,
