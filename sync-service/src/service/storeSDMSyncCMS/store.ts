...
//     await Aerospike.truncate({ set: 'sync_store' });
...
//                         ...areaDetail, // countryId / provinceId / cityId
...
//                 let geoFenceAllData = [];
//                 for (let i = 0; i < store.Fences.CC_STORE_MAP_FENCE.length; i++) {
//                     geoFenceAllData.push({
//                         geofenceName: store.Fences.CC_STORE_MAP_FENCE[i].MAPF_DESCRIPTION,
...
//                     countryId: 'AE',
//                     menuId: parseInt(store.STR_WEB_MNUID),
//                     provinceId: store.Locations.CC_STORE_MAP_LOCATION.MAPL_PROVINCEID,
//                     areaId: store.Locations.CC_STORE_MAP_LOCATION.MAPL_PROVINCEID,
//                     streetId: store.Locations.CC_STORE_MAP_LOCATION.MAPL_PROVINCEID,
