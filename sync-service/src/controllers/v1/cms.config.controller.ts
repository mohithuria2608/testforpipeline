                                ...
                                for (const config of data.data) {
                                    let dataToSave: IConfigRequest.IConfig = {
                                        ...
                                        general: {
                                            ...
                                            support: config.support ? config.support : Constant.CONF.GENERAL.CUSTOMER_CARE,
                                            customer_care_email: config.customer_care_email ? config.customer_care_email : Constant.CONF.GENERAL.SUPPORT_EMAIL,
                                            ...
                                            minimum_cart_price: config.minimum_cart_price ? parseInt(config.minimum_cart_price) : Constant.CONF.GENERAL.MIN_CART_VALUE,
