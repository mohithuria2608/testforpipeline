...
export let sendError = function (error, language: string = Constant.DATABASE.LANGUAGE.EN) {
    ...
    if (error && error.code && error.details) {
        ...
        if (error.name == "AerospikeError") {
            ...
            customError.message_Ar = error.payload.message
            customError.message_En = error.payload.message
    ...
    customError.message_Ar = customError.message && customError.message.replace(/"/g, '')
    customError.message_Ar = customError.message && customError.message.replace('[', '')
    customError.message_Ar = customError.message && customError.message.replace(']', '')

    customError.message_En = customError.message && customError.message.replace(/"/g, '')
    customError.message_En = customError.message && customError.message.replace('[', '')
    customError.message_En = customError.message && customError.message.replace(']', '')
