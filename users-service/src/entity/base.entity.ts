...
export class BaseEntity {
    ...
    async createOneEntity(saveData: Object) {
        try {
            ...
            consolelog('Base entity createOneEntity', error, false)
    ...
    async createMulti(saveData: any) {
        try {
            ...
            consolelog('Base entity createMulti', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async getOneEntity(criteria: Object, projection: Object, option?) {
        try {
            ...
            consolelog('Base entity getOneEntity', error, false)
            return Promise.reject(error)
        }
    ...
    async updateOneEntity(criteria: Object, dataToUpdate: Object, option?) {
        try {
            ...
            consolelog('Base entity updateOneEntity', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async replaceOneEntity(criteria: Object, replacement: Object, option?) {
        try {
            ...
            consolelog('Base entity replaceOneEntity', error, false)
            return Promise.reject(error)
        }
    ...
    async getById(_id: string, projection: Object) {
        try {
            ...
            consolelog('Base entity getById', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async getMultiple(criteria: Object, projection: Object) {
        try {
            ...
            consolelog('Base entity getMultiple', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async getDistinct(key: string, criteria: Object) {
        try {
            ...
            consolelog('Base entity getDistinct', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async updateMultiple(criteria: Object, projection: Object, option?) {
        try {
            ...
            consolelog('Base entity updateMultiple', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async aggregate(pipeline, option?) {
        try {
            ...
            consolelog('Base entity aggregate', error, false)
            return Promise.reject(error)
        }
    }
    ...
    async findAndRemove(criteria: Object) {
        try {
            ...
            consolelog('Base entity findAndRemove', error, false)
            return Promise.reject(error)
        }
    };
    ...
    async count(criteria: Object) {
        try {
            ...
            consolelog('Base entity count', error, false)
            return Promise.reject(error)
        }
    }
}