        ...
        .post('/',
            ...
            validate({
                ...
                body: {
                    ...
                    storeId: Joi.number(),
                    lat: Joi.number().unsafe().min(-90).max(90).error(new Error(Constant.STATUS_MSG.ERROR.E422.INVALID_LOCATION.type)),
                    lng: Joi.number().unsafe().min(-180).max(180).error(new Error(Constant.STATUS_MSG.ERROR.E422.INVALID_LOCATION.type)),
        ...
        .patch('/',
            ...
            validate({
                ...
                body: {
                    ...
                    lat: Joi.number().unsafe().min(-90).max(90).required().error(new Error(Constant.STATUS_MSG.ERROR.E422.INVALID_LOCATION.type)),
                    lng: Joi.number().unsafe().min(-180).max(180).required().error(new Error(Constant.STATUS_MSG.ERROR.E422.INVALID_LOCATION.type)),
